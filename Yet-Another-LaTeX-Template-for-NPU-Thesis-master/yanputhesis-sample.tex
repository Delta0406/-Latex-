...
\AddToShipoutPicture*{
	\put(-5,-5){
		\parbox[b][\paperheight]{\paperwidth}{
			\vfill
			\centering
			\includegraphics[width=1.05\paperwidth,height=1.05\paperheight,keepaspectratio,angle=0]{./images/封面.pdf}
			\vfill
		}
	}
} % 封面，如需要不带封面的版本，可按Ctrl+T注释掉
...
\begin{abstract}                                            % 中文摘要开始
    ...
    \begin{keywords}                                        % 中文关键词开始
        学位论文 \sep 模板 \sep 最好 \sep 五个 \sep 关键词                      %
...
\begin{engabstract}                                         % 英文摘要开始
    ...
    \begin{engkeywords}                                     % 英文关键词开始
        thesis \ensep template \ensep best \ensep five \ensep key words                %
